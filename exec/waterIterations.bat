...
for /L %%i in (1,1,10) do (
    ...
    echo WATER - Index...
    node ../models/isolationForest/index.js ../results/!treesFolder!/addColumn.csv ../results/!treesFolder!/auxiliaryWeight.csv 25 ../results/!treesFolder!/!iterFolder!/ isolation.csv scores.csv metrics.csv image ./waterConfig.json
    if !errorlevel! neq 0 exit /b !errorlevel!
