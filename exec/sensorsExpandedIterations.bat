...
node ../processing/createGroups.js ../results/!treesFolder!/normalize.csv ../results/!treesFolder!/addColumn.csv ../results/!treesFolder!/createGroups ./sensorsConfig.json
if !errorlevel! neq 0 exit /b !errorlevel!
