...
for /L %%i in (1,1,10) do (
    ...
    node ../processing/expandedColumn.js ../dataset/!treesFolder!/!iterFolder!/flatten.json ../dataset/!treesFolder!/!iterFolder!/expandedColumn.json ./sensorsConfig.json
    if %errorlevel% neq 0 exit /b %errorlevel%

    echo SENSORS EXPANDED 5 - To CSV..
    node ../processing/toCsv.js ../dataset/!treesFolder!/!iterFolder!/expandedColumn.json ../dataset/!treesFolder!/!iterFolder!/toCsv.csv ./sensorsConfig.json
    if %errorlevel% neq 0 exit /b %errorlevel%
