...
echo -> SENSORS EXPANDED 4 - Expanded Column...
node ./processing/expandedColumn.js ./dataset/flatten.json ./dataset/expandedColumn.json ./sensorsConfig.json
if %errorlevel% neq 0 exit /b %errorlevel%

echo -> SENSORS EXPANDED 5 - To CSV...
node ./processing/toCsv.js ./dataset/expandedColumn.json ./dataset/toCsv.csv ./sensorsConfig.json
if %errorlevel% neq 0 exit /b %errorlevel%
